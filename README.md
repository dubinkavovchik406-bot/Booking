...
EN:
1. Download project to your devace, using zip-file or link for project. / (if you use link) `git clone https://github.com/KovalskyDev/Booking.git`
...
RU:
1. Загрузите проект на ваше устройство, используя ZIP-архив или ссылку на проект / (в случае с ссылкой) `git clone https://github.com/KovalskyDev/Booking.git`
